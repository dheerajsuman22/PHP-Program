...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/sentemail.css">
</head>
<body>
</body>
    ...
    <div class="col-lg-12">
        <div class="box">
            ...
            <div class="mail-box">
                ...
                $sql = "SELECT * FROM composetable1 WHERE sender='$sender' AND status=1 ORDER BY `date` DESC";
                ...
                if ($num > 0) {
                   while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <td class="view-message ">'.substr($row['message'], 0 , 20).'</td>
                    <td class="view-message  inbox-small-cells"><i class="fa fa-paperclip"></i></td>
                    <td class="view-message  text-right">'.$row['date'].'</td>
                    <td class="view-message  text-right"><a href="sentupdate.php?sno='.$row['sno'].'"><i class="fa fa-trash-o"></a></td>
                </tr>';
                    } 
