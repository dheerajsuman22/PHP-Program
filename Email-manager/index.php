            ...
            <div class="mail-box">
                <aside class="sm-side">
                   ...
                   <?php require "compose.php";?>
                    ...
                    <ul class="nav inbox-nav inbox-divider">
                        <li class="active nav-item">
                            <a href="index.php" class="nav-link"><i class="fa fa-inbox"></i> Inbox 
                ...
                $sql = "SELECT * FROM composetable WHERE receiver ='$email' AND status=1 ORDER BY `date` DESC";
                ...
                if ($num >0){
                   while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <td class="view-message  text-right"><a href="indexupdate.php?sno='.$row['sno'].'"><i class="fa fa-trash-o"></a></td>
                </tr>';
                    } 
